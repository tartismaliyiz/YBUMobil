 ...
 */
public class DuyuruWidgetSpinnerListAdapter extends ArrayAdapter<String> {
    private final Context context;
    private final ArrayList<String> values;
    private int rowViewID;

    public DuyuruWidgetSpinnerListAdapter(Context context, int rowView, int textView, ArrayList<String> values) {
