...
public class DuyuruWidgetConfigureActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        final DuyuruWidgetConfigureJson jsonData = new DuyuruWidgetConfigureJson("http://api.ybubiltek.org/mobilybu/android/duyuruWidget.php");
        jsonData.fetchJSON();
        ...
        intervalSpinner.setAdapter(
                new DuyuruWidgetConfigureSpinnerListAdapter(
                        getApplicationContext(),
